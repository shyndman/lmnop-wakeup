...
CHARACTER_POOL = CharacterPool(
  pool=[
    ...
    Character(
      ...
      pronouns="she/her",
      voice="Zephyr",
      personality="A competent, professional meteorologist who delivers weather forecasts fairly normally. But she speaks in a deep voice, rapidly, with very little inflection.",
      specialty="weather",
      script_writer_instructions="Clara should be completely professional...just a little strange sounding.",
    ),
    Character(
      slug="sam",
      name="Sam Washington",
